...
\begin{itemize}
	...
	\item Gene priorities that have a large proper value (usually, the Total Force Gene (see Sec.~\ref{total-force-and-pawn-result}) can achieve that value quickly,
