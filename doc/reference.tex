...
The queen's value is forced to be non-negative. This tends to speed up the evolution of the other piece values and the priorities of the Total Force Gene and the Opponent Pieces Targeted Gene without limiting their range of mutations. If the proper value of a queen is negative (meaning that, for example, the Total Force Gene makes a player want to get rid of their own queen), then this can be expressed by the Total Force Gene taking on a negative value.
...
\subsubsection{Update after deleting the Branch Pruning Gene}
