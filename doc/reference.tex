...
\begin{figure}[htb]
	...
	\caption{Running counts of the wins, losses, and draws by white and black players. The advantage that white has over black seems persistent. Also, as the AIs evolve, the rate of draws decreases.}
	\label{win-lose-plot}
\end{figure}
...
\begin{figure}[htb]
	...
	\caption{Running counts on a log-log scale of all the ways the chess games end. Note that the time forfeits don't get going until about 30,000 games in.}
