...
void Castle::side_effects(Board& board) const noexcept
{
    ...
    board.castling_index[static_cast<unsigned>(board.whose_turn())] = board.game_length() - 1;
    board.castling_movement[static_cast<unsigned>(board.whose_turn())] = file_change();
}
