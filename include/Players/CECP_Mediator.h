...
class CECP_Mediator : public Outside_Communicator
{
    public:
        ...
        bool pondering_allowed(const Board& board) override;
    ...
    private:
        ...
        bool undo_move(std::vector<const Move*>& move_list, std::string& command, std::unique_ptr<Board>& board, Clock& clock);
