...
OBJ_DEBUG = $(DEBUG_OBJ_DIR)/main.o $(DEBUG_OBJ_DIR)/src/Breeding/Gene_Pool.o $(DEBUG_OBJ_DIR)/src/Exceptions/Game_Ending_Exception.o $(DEBUG_OBJ_DIR)/src/Exceptions/Illegal_Move_Exception.o $(DEBUG_OBJ_DIR)/src/Game/Board.o $(DEBUG_OBJ_DIR)/src/Game/Clock.o $(DEBUG_OBJ_DIR)/src/Game/Color.o $(DEBUG_OBJ_DIR)/src/Game/Game.o $(DEBUG_OBJ_DIR)/src/Game/Game_Result.o $(DEBUG_OBJ_DIR)/src/Game/Square.o $(DEBUG_OBJ_DIR)/src/Genes/Castling_Possible_Gene.o $(DEBUG_OBJ_DIR)/src/Genes/Freedom_To_Move_Gene.o $(DEBUG_OBJ_DIR)/src/Genes/Gene.o $(DEBUG_OBJ_DIR)/src/Genes/Genome.o $(DEBUG_OBJ_DIR)/src/Genes/King_Confinement_Gene.o $(DEBUG_OBJ_DIR)/src/Genes/King_Protection_Gene.o $(DEBUG_OBJ_DIR)/src/Genes/Look_Ahead_Gene.o $(DEBUG_OBJ_DIR)/src/Genes/Opponent_Pieces_Targeted_Gene.o $(DEBUG_OBJ_DIR)/src/Genes/Passed_Pawn_Gene.o $(DEBUG_OBJ_DIR)/src/Genes/Pawn_Advancement_Gene.o $(DEBUG_OBJ_DIR)/src/Genes/Piece_Strength_Gene.o $(DEBUG_OBJ_DIR)/src/Genes/Priority_Threshold_Gene.o $(DEBUG_OBJ_DIR)/src/Genes/Sphere_of_Influence_Gene.o $(DEBUG_OBJ_DIR)/src/Genes/Total_Force_Gene.o $(DEBUG_OBJ_DIR)/src/Moves/En_Passant.o $(DEBUG_OBJ_DIR)/src/Moves/Kingside_Castle.o $(DEBUG_OBJ_DIR)/src/Moves/Move.o $(DEBUG_OBJ_DIR)/src/Moves/Pawn_Capture.o $(DEBUG_OBJ_DIR)/src/Moves/Pawn_Double_Move.o $(DEBUG_OBJ_DIR)/src/Moves/Pawn_Move.o $(DEBUG_OBJ_DIR)/src/Moves/Pawn_Promotion.o $(DEBUG_OBJ_DIR)/src/Moves/Pawn_Promotion_by_Capture.o $(DEBUG_OBJ_DIR)/src/Moves/Queenside_Castle.o $(DEBUG_OBJ_DIR)/src/Moves/Threat_Generator.o $(DEBUG_OBJ_DIR)/src/Moves/Threat_Iterator.o $(DEBUG_OBJ_DIR)/src/Pieces/Bishop.o $(DEBUG_OBJ_DIR)/src/Pieces/King.o $(DEBUG_OBJ_DIR)/src/Pieces/Knight.o $(DEBUG_OBJ_DIR)/src/Pieces/Pawn.o $(DEBUG_OBJ_DIR)/src/Pieces/Piece.o $(DEBUG_OBJ_DIR)/src/Pieces/Queen.o $(DEBUG_OBJ_DIR)/src/Pieces/Rook.o $(DEBUG_OBJ_DIR)/src/Players/Alan_Turing_AI.o $(DEBUG_OBJ_DIR)/src/Players/CECP_Mediator.o $(DEBUG_OBJ_DIR)/src/Players/Claude_Shannon_AI.o $(DEBUG_OBJ_DIR)/src/Players/Game_Tree_Node_Result.o $(DEBUG_OBJ_DIR)/src/Players/Genetic_AI.o $(DEBUG_OBJ_DIR)/src/Players/Human_Player.o $(DEBUG_OBJ_DIR)/src/Players/Minimax_AI.o $(DEBUG_OBJ_DIR)/src/Players/Outside_Player.o $(DEBUG_OBJ_DIR)/src/Players/Player.o $(DEBUG_OBJ_DIR)/src/Players/Random_AI.o $(DEBUG_OBJ_DIR)/src/Players/UCI_Mediator.o $(DEBUG_OBJ_DIR)/src/Stalemate_Search.o $(DEBUG_OBJ_DIR)/src/Testing.o $(DEBUG_OBJ_DIR)/src/Utility.o
...
OBJ_OPTIMIZED_DEBUG = $(OPTIMIZED_DEBUG_OBJ_DIR)/main.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Breeding/Gene_Pool.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Exceptions/Game_Ending_Exception.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Exceptions/Illegal_Move_Exception.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Game/Board.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Game/Clock.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Game/Color.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Game/Game.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Game/Game_Result.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Game/Square.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Castling_Possible_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Freedom_To_Move_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Genome.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/King_Confinement_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/King_Protection_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Look_Ahead_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Opponent_Pieces_Targeted_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Passed_Pawn_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Pawn_Advancement_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Piece_Strength_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Priority_Threshold_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Sphere_of_Influence_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Genes/Total_Force_Gene.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Moves/En_Passant.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Moves/Kingside_Castle.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Moves/Move.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Moves/Pawn_Capture.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Moves/Pawn_Double_Move.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Moves/Pawn_Move.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Moves/Pawn_Promotion.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Moves/Pawn_Promotion_by_Capture.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Moves/Queenside_Castle.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Moves/Threat_Generator.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Moves/Threat_Iterator.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Pieces/Bishop.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Pieces/King.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Pieces/Knight.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Pieces/Pawn.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Pieces/Piece.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Pieces/Queen.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Pieces/Rook.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Players/Alan_Turing_AI.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Players/CECP_Mediator.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Players/Claude_Shannon_AI.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Players/Game_Tree_Node_Result.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Players/Genetic_AI.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Players/Human_Player.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Players/Minimax_AI.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Players/Outside_Player.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Players/Player.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Players/Random_AI.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Players/UCI_Mediator.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Stalemate_Search.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Testing.o $(OPTIMIZED_DEBUG_OBJ_DIR)/src/Utility.o
...
$(OPTIMIZED_DEBUG_OBJ_DIR)/main.o : main.cpp include/Breeding/Gene_Pool.h include/Exceptions/Illegal_Move_Exception.h include/Game/Board.h include/Game/Color.h include/Game/Game.h include/Game/Game_Result.h include/Game/Square.h include/Genes/Gene.h include/Genes/Genome.h include/Moves/En_Passant.h include/Moves/Kingside_Castle.h include/Moves/Move.h include/Moves/Pawn_Capture.h include/Moves/Pawn_Double_Move.h include/Moves/Pawn_Move.h include/Moves/Pawn_Promotion.h include/Moves/Queenside_Castle.h include/Pieces/Piece_Types.h include/Players/Genetic_AI.h include/Players/Human_Player.h include/Players/Minimax_AI.h include/Players/Outside_Player.h include/Players/Player.h include/Players/Random_AI.h include/Players/Thinking.h include/Stalemate_Search.h include/Testing.h include/Utility.h
...
$(RELEASE_OBJ_DIR)/main.o : main.cpp include/Breeding/Gene_Pool.h include/Exceptions/Illegal_Move_Exception.h include/Game/Board.h include/Game/Color.h include/Game/Game.h include/Game/Game_Result.h include/Game/Square.h include/Genes/Gene.h include/Genes/Genome.h include/Moves/En_Passant.h include/Moves/Kingside_Castle.h include/Moves/Move.h include/Moves/Pawn_Capture.h include/Moves/Pawn_Double_Move.h include/Moves/Pawn_Move.h include/Moves/Pawn_Promotion.h include/Moves/Queenside_Castle.h include/Pieces/Piece_Types.h include/Players/Genetic_AI.h include/Players/Human_Player.h include/Players/Minimax_AI.h include/Players/Outside_Player.h include/Players/Player.h include/Players/Random_AI.h include/Players/Thinking.h include/Stalemate_Search.h include/Testing.h include/Utility.h
